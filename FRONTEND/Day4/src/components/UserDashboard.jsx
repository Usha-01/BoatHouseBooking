...
<>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
        <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Dashboard_user")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
              ...
              >
                ...
                <ListItemText primary="User Dashboard" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
        ...
        <Divider />
                    ...
                    <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/book")}}>
                          ...
                          >
                            ...
                            <ListItemText primary="Book Boat" sx={{ opacity: open ? 1 : 0 }} />
                          </ListItemButton>
                        </ListItem>
                    </List>
